...
customCommandHooks.setRankRequirement("pc", config.rankRequired)
customCommandHooks.setRankRequirement("ac", config.rankRequired)
customCommandHooks.setRankRequirement("addfurn", config.rankRequired)
customCommandHooks.setRankRequirement("af", config.rankRequired)
