...
scriptConfig.bankerRefIds = {"m'aiq", "furn_dwrv_stove00", "com_sack_02_pos"}
...
Methods.CreateContainerForPlayer = function(playerName)
	...
	local objectData = {}
	objectData.refId = scriptConfig.recordRefId
	local uniqueIndex = logicHandler.CreateObjectAtLocation(scriptConfig.storageCell, location, objectData, packetType)
